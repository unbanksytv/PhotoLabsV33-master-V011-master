      ...
      <div className="divide-y divide-neutral-100 dark:divide-neutral-800">
        ...
        <div className="pb-9 space-y-5">
          <div className="flex justify-between items-center">
            <Badge name="The DDA Collection" color="yellow" />
            <LikeSaveBtns />
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-8 text-sm">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2.5 text-neutral-500 dark:text-neutral-400 flex flex-col">
                ...
                <span className="text-neutral-900 dark:text-neutral-200 font-medium flex items-center">
                  <span>{"Dimitri Daniloff Archives"}</span>
                  <VerifyIcon iconClass="w-4 h-4" />
                </span>
              </span>
            </div>
        ...
        <div className="pb-9 pt-14">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between">
            <div className="flex-1 flex flex-col sm:flex-row items-baseline p-6 border-2 border-yellow-400 rounded-xl relative">
              <span className="absolute bottom-full translate-y-1 py-1 px-1.5 bg-white dark:bg-neutral-900 text-sm text-neutral-500 dark:text-neutral-400">
                Current Bid
              </span>
              <span className="text-3xl xl:text-4xl font-bold text-green-500">
                33 OHM
              </span>
