...
const DEMO_DATA: CommentListingDataType = {
  ...
  date: "May 20, 2022",
  comment:
  "The most important thing a creator can do is listen to and learn from the community and the market. We have been watching carefully and felt that given the current climate and state of the market, the most exciting way to grow our community organically will be through a free mint. ",
  starPoint: 5,
};
