...
const solutions = [
  {
    name: "Degen Vibes",
    description: "The Degen Vibes have no stated goals or mission statement. Good Vibes OHMly. They represent the brand DNA we cultivated over the past 25 years. They showcase our passion for surf, film, photography, etc, ...",
    time: "3 minutes ago",
    href: "##",
  },
  {
    name: "Good Vibes Ohmly",
    description: "Empowering creators to do what they love",
    time: "1 minute ago",
    href: "##",
  },
  {
    name: "Live The Life",
    description: "Supported by people that love what they do",
    time: "3 minutes ago",
    href: "##",
  },
];
